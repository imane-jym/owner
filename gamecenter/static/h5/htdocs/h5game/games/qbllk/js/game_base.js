if (void 0 == APP_BASE_URL) var APP_BASE_URL = "http://game.jvziyouxi.com/";
if (void 0 == GAME_LIST_URL) var GAME_LIST_URL = "http://game.jvziyouxi.com/";
if (void 0 == FOLLOW_URL) var FOLLOW_URL = "http://game.jvziyouxi.com/";
var BASE_RES_DIR = "../",
	RES_DIR = "",
	APP_DEPLOYMENT = "WEB",
	USE_NATIVE_SOUND = !1,
	...
	SHOW_COPYRIGHT = !1,
	IN_WEIXIN = !1;
0 <= document.URL.indexOf("file://") && (IS_ANDROID || IS_IOS) && (APP_DEPLOYMENT = "APP", USE_NATIVE_SOUND = USE_NATIVE_SHARE = !0, APP_BASE_URL = "http://game.jvziyouxi.com/");
...
var mebtnopenurl = "http://mp.weixin.qq.com/s?__biz=MzIxMDQxOTU4OA==&mid=100000004&idx=1&sn=673d5a570646267667c095ca55c96558&scene=18#wechat_redirect";

window.shareData = {
    "imgUrl": "http://game.jvziyouxi.com/icon/qbllk.png",
    "timeLineLink": "http://game.jvziyouxi.com/games/qbllk/",
    "tTitle": "奇葩连连看-桔子游戏",
