...
;~function(bt){
	...
	bt.URL = {
		root: "http://game.jvziyouxi.com"
		,getMoreGame: function(){
			// 点击更多
			bt.dc("more");
			
			return "http://game.jvziyouxi.com";
		}
		,getConcern: function(){
			return "http://mp.weixin.qq.com/s?__biz=MzIxMDQxOTU4OA==&mid=100000004&idx=1&sn=673d5a570646267667c095ca55c96558&scene=18#wechat_redirect";
		}
