...
static const char qt_meta_stringdata_Tiled__Internal__StampBrush[] = {
    ...
    "value\0setRandom(bool)\0"
};

void Tiled::Internal::StampBrush::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        StampBrush *_t = static_cast<StampBrush *>(_o);
        switch (_id) {
        case 0: _t->currentTilesChanged((*reinterpret_cast< const TileLayer*(*)>(_a[1]))); break;
        case 1: _t->setRandom((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Tiled::Internal::StampBrush::staticMetaObjectExtraData = {
...
const QMetaObject Tiled::Internal::StampBrush::staticMetaObject = {
    { &AbstractTileTool::staticMetaObject, qt_meta_stringdata_Tiled__Internal__StampBrush,
      qt_meta_data_Tiled__Internal__StampBrush, &staticMetaObjectExtraData }
};
