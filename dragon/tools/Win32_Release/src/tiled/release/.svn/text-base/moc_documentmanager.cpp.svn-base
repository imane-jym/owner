...
void Tiled::Internal::DocumentManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        DocumentManager *_t = static_cast<DocumentManager *>(_o);
        switch (_id) {
        case 0: _t->currentDocumentChanged((*reinterpret_cast< MapDocument*(*)>(_a[1]))); break;
        case 1: _t->documentCloseRequested((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->switchToLeftDocument(); break;
        case 3: _t->switchToRightDocument(); break;
        case 4: _t->currentIndexChanged(); break;
        case 5: _t->setSelectedTool((*reinterpret_cast< AbstractTool*(*)>(_a[1]))); break;
        case 6: _t->updateDocumentTab(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Tiled::Internal::DocumentManager::staticMetaObjectExtraData = {
...
const QMetaObject Tiled::Internal::DocumentManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Tiled__Internal__DocumentManager,
      qt_meta_data_Tiled__Internal__DocumentManager, &staticMetaObjectExtraData }
};
