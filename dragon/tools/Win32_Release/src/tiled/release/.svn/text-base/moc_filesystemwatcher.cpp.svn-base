...
#include "../../../../tiled/src/tiled/filesystemwatcher.h"
...
static const char qt_meta_stringdata_Tiled__Internal__FileSystemWatcher[] = {
    "Tiled::Internal::FileSystemWatcher\0\0"
...
const QMetaObjectExtraData Tiled::Internal::FileSystemWatcher::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Tiled::Internal::FileSystemWatcher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Tiled__Internal__FileSystemWatcher,
      qt_meta_data_Tiled__Internal__FileSystemWatcher, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Tiled::Internal::FileSystemWatcher::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Tiled__Internal__FileSystemWatcher))
