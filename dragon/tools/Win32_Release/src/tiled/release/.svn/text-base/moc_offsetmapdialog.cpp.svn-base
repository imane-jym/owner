...
void Tiled::Internal::OffsetMapDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData Tiled::Internal::OffsetMapDialog::staticMetaObjectExtraData = {
...
const QMetaObject Tiled::Internal::OffsetMapDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Tiled__Internal__OffsetMapDialog,
      qt_meta_data_Tiled__Internal__OffsetMapDialog, &staticMetaObjectExtraData }
};
