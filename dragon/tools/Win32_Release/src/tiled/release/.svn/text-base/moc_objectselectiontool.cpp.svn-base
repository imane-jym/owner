...
void Tiled::Internal::ObjectSelectionTool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData Tiled::Internal::ObjectSelectionTool::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Tiled::Internal::ObjectSelectionTool::staticMetaObject = {
    { &AbstractObjectTool::staticMetaObject, qt_meta_stringdata_Tiled__Internal__ObjectSelectionTool,
      qt_meta_data_Tiled__Internal__ObjectSelectionTool, &staticMetaObjectExtraData }
};
