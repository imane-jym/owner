...
void Tiled::Internal::CreateObjectTool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        CreateObjectTool *_t = static_cast<CreateObjectTool *>(_o);
        switch (_id) {
        case 0: _t->setTile((*reinterpret_cast< Tile*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Tiled::Internal::CreateObjectTool::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Tiled::Internal::CreateObjectTool::staticMetaObject = {
    { &AbstractObjectTool::staticMetaObject, qt_meta_stringdata_Tiled__Internal__CreateObjectTool,
      qt_meta_data_Tiled__Internal__CreateObjectTool, &staticMetaObjectExtraData }
};
