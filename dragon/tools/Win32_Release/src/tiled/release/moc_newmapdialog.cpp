...
static const char qt_meta_stringdata_Tiled__Internal__NewMapDialog[] = {
    "Tiled::Internal::NewMapDialog\0\0"
    "refreshPixelSize()\0"
};

void Tiled::Internal::NewMapDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        NewMapDialog *_t = static_cast<NewMapDialog *>(_o);
        switch (_id) {
        case 0: _t->refreshPixelSize(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData Tiled::Internal::NewMapDialog::staticMetaObjectExtraData = {
...
const QMetaObject Tiled::Internal::NewMapDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Tiled__Internal__NewMapDialog,
      qt_meta_data_Tiled__Internal__NewMapDialog, &staticMetaObjectExtraData }
};
